...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWFtZGV2aWxkZXZlbG9wZXIiLCJhIjoiY2thMTh5bXluMDlobDNocDYwOWdhZmRibCJ9.c0IlH9v-E---fRCpZn8uDA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map); // Extend map bound to include current map locations
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Please visit again. Have a nice day.');
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:7777/api/v1/users/updatePassword' : 'http://127.0.0.1:7777/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51H4rFuJMoK2Q7BWYTrSnEJZgyCagMLqgi1A96ox13iKPZM0QQ1hwlQw9HY7K0tesje6MMDDxygXdlYVMN9cTqbJ000aooY6ot8');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:7777/api/v1/bookings/checkout-session/".concat(tourId));
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var updateForm = document.querySelector('.user-update-form');
var updatePasswordForm = document.querySelector('#update-password-form');
var loginForm = document.querySelector('#login-form');
var logoutBtn = document.querySelector('#logout');
var bookBtn = document.querySelector('#book-tour'); // Functionalities
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var oldPassword = document.getElementById('password-current').value;
    var password = document.getElementById('password').value;
